...
namespace skyline::applet {
    /**
     * @brief The Offline Web is utilized by the guest to display offline web pages
     */
    class OfflineWebApplet : public service::am::IApplet, service::am::EnableNormalQueue {
      private:
        #pragma pack(push, 1)
        ...
        struct WebCommonReturnValue {
            ...
            std::array<char, 0x800> lastUrlSize;
        };
        static_assert(sizeof(WebCommonReturnValue) == 0x1808);
      ...
      public:
        OfflineWebApplet(const DeviceState &state, service::ServiceManager &manager, std::shared_ptr<kernel::type::KEvent> onAppletStateChanged, std::shared_ptr<kernel::type::KEvent> onNormalDataPushFromApplet, std::shared_ptr<kernel::type::KEvent> onInteractiveDataPushFromApplet, service::applet::LibraryAppletMode appletMode);
